...
#         --bounded_actor True --tag ppov2_256_3e-4_bound_nnlogstd_256 \
...
python3 test_algs/run_algs.py --alg_name sac --env_type mujoco \
        --env_name Hopper-v2 --device "cuda:0" --use_prev_action False \
        --bounded_actor False --tag sac_256_3e-4_unbound_nnlogstd_256 \
        --max_explore_step 6e6 --mini_batch_size 256  --clip_grad_val 0 \
        --use_nn_logstd True --clamp_action_logstd False --miql_stream True \
        --use_prev_action_dim True --use_prev_option_dim True \
        --optimizer_lr_policy 3.e-4 --optimizer_lr_critic 3.e-4 --seed 0 \
