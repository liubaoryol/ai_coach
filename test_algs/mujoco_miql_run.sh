...
python3 test_algs/run_mujoco.py --alg_name miql --env_type mujoco \
        --env_name Hopper-v2 --tag txregval --seed 0 \
...
# # Walker2d-v2
# python3 test_algs/run_mujoco.py --alg_name miql --env_type mujoco \
#         --env_name Walker2d-v2 --tag txregval --seed 0 \
...
# # Humanoid-v2
# python3 test_algs/run_mujoco.py --alg_name miql --env_type mujoco \
#         --env_name Humanoid-v2 --tag txregval --seed 0 \
...
# # Ant-v2
# python3 test_algs/run_mujoco.py --alg_name miql --env_type mujoco \
#         --env_name Ant-v2 --tag txregval --seed 0 \
...
# # HalfCheetah-v2
# python3 test_algs/run_mujoco.py --alg_name miql --env_type mujoco \
#         --env_name HalfCheetah-v2 --tag txregval --seed 0 \
