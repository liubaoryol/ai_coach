...
from ai_coach_domain.box_push.transition import (get_box_idx_impl,
...
def transition_mixed(box_states: list, a1_pos: Coord, a2_pos: Coord,
  ...
  def get_moved_coord(coord, action, check_box=False, holding_box=False):
  ...
  def update_dropped_box_state(boxidx, coord, box_states_new):
    ...
    return res, conv_box_idx_2_state(box_states_new[bidx], num_drops, num_goals)
  ...
  if hold == "None":
    if (a1_act == EventType.HOLD and a2_act == EventType.HOLD
      ...
      if a1_act == EventType.HOLD:
        ...
        a1_pos_new = get_moved_coord(a1_pos, a1_act, False, False)
      ...
      if a2_act == EventType.HOLD:
        ...
        a2_pos_new = get_moved_coord(a2_pos, a2_act, False, False)
  ...
  # both hold the same box
    ...
    # only agent1 try to unhold
      ...
      a2_pos_new = get_moved_coord(a2_pos, a2_act, True, True)
      ...
      a1_pos_new = get_moved_coord(a1_pos, a1_act, True, True)
    ...
    # when both try to move
      ...
      if agent_dist > 2:
        ...
        if a1_pos_new != a1_pos and a2_pos_new != a2_pos:
          ...
          a2_pos_new2 = get_moved_coord(a2_pos, a2_act, False, True)
          ...
          a1_pos_new2 = get_moved_coord(a1_pos, a1_act, False, True)
