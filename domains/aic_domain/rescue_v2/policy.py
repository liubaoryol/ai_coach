...
from aic_domain.box_push.policy import PolicyFromIdenticalAgentMDP
from aic_domain.rescue_v2.mdp import MDP_Rescue
...
class Policy_Rescue(PolicyFromIdenticalAgentMDP):
  ...
  def _convert_task_state_2_agent_state(self, obstate_idx):
    work_states, a1_pos, a2_pos, a3_pos = self.mdp.conv_mdp_sidx_to_sim_states(
        obstate_idx)
