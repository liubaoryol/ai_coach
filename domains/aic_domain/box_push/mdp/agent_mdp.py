import numpy as np
from aic_domain.box_push import (BoxState, EventType, conv_box_state_2_idx,
                                 conv_box_idx_2_state, AGENT_ACTIONSPACE)
from aic_domain.box_push.transition import (transition_alone_and_together,
...
if __name__ == "__main__":
  ...
  from aic_domain.box_push.maps import TEST_MAP3
  game_map = TEST_MAP3
