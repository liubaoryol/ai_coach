...
def make_sac_agent(env: gym.Env,
  ...
  agent = SAC(obs_dim, action_dim, batch_size, discrete_obs, discrete_act,
              device_name, gamma, critic_tau, critic_lr,
              critic_target_update_frequency, init_temp, critic_betas, use_tanh,
              critic_base, actor_base, learn_temp, actor_update_frequency,
              actor_lr, actor_betas, alpha_lr, alpha_betas, critic_hidden_dim,
              critic_hidden_depth, actor_hidden_dim, actor_hidden_depth,
              log_std_bounds)
