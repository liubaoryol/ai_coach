...
def action_event(msg,
  ...
  # TODO: maybe need to move this code later this function.
  # esp. check if there is no problem when game is finished
  if intervention:
    helper.task_intervention(game.history, game, env_id, name_space)
