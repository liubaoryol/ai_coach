...
def run_game(msg):
  event_impl.run_game(msg, EXP1_TUT_NAMESPACE, g_id_2_game, GRID_X, GRID_Y, {})


@socketio.on('action_event', namespace=EXP1_TUT_NAMESPACE)
def on_key_down(msg):
  event_impl.on_key_down(msg, EXP1_TUT_NAMESPACE, g_id_2_game)


@socketio.on('set_latent', namespace=EXP1_TUT_NAMESPACE)
def set_latent(msg):
  event_impl.set_latent(msg, EXP1_TUT_NAMESPACE, g_id_2_game)
