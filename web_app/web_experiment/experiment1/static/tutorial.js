...
$(document).ready(function () {
  ...
  global_object.page_list.push(new PageJoystick("Joystick1", global_object, game_obj, control_ui, cnvs, socket));
  global_object.page_list.push(new PageJoystick2("Joystick2", global_object, game_obj, control_ui, cnvs, socket));
  global_object.page_list.push(new PageOnlyHuman("OnlyHuman", global_object, game_obj, control_ui, cnvs, socket));
  global_object.page_list.push(new PageTarget("Target1", global_object, game_obj, control_ui, cnvs, socket, "box"));
  global_object.page_list.push(new PageTarget2("Target2", global_object, game_obj, control_ui, cnvs, socket, "box"));
  global_object.page_list.push(new PageDestination("Destination", global_object, game_obj, control_ui, cnvs, socket, "box"));
  global_object.page_list.push(new PageScore("Score", global_object, game_obj, control_ui, cnvs, socket));
  global_object.page_list.push(new PageTrappedScenario("Trapped", global_object, game_obj, control_ui, cnvs, socket, "box"));
  ...
  global_object.page_list.push(new PageUserLatent("User Prompt", global_object, game_obj, control_ui, cnvs, socket, "box"));
