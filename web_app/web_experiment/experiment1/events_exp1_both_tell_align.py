...
for session_name in [td.SESSION_A1, td.SESSION_A2]:
  ...
  def run_game(msg,
    ...
    event_impl.run_task_game(msg, td.map_g_id_2_game[session_name], agent2,
                             ...
                             event_impl.NOT_ASK_LATENT, name_space, task_type)
  ...
  def action_event(msg,
    ...
    event_impl.action_event(msg, td.map_g_id_2_game[session_name], hold_changed,
                            event_impl.game_end, name_space, False, False,
