...
if __name__=="__main__":
    ...
    for key in dict_results:
        print(key)
        str_res = (
            str(dict_results[key]['x mean'][0][0]) + ',' + str(dict_results[key]['x mean'][1][0]) + ',' +
            str(dict_results[key]['x mean'][0][1]) + ',' + str(dict_results[key]['x mean'][1][1]) + ',' +
            str(dict_results[key]['wJS'][0][0]) + ',' + str(dict_results[key]['wJS'][1][0]) + ',' +
            str(dict_results[key]['wJS'][0][1]) + ',' + str(dict_results[key]['wJS'][1][1])
            )
        print(str_res)
