...
########################### Mental-IQL:
# Ant-v2
python3 train_dnn/run_algs.py alg=iql env=Ant-v2 base_setting=mujoco_base \
...
# Humanoid-v2
python3 train_dnn/run_algs.py alg=iql env=Humanoid-v2 base_setting=mujoco_base \
