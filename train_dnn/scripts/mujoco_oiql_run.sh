...
python3 test_algs/run_mujoco.py --alg_name oiql --env_type mujoco \
        ...
        --use_nn_logstd True --method_loss "v0" --init_temp 1e-2
...
#         --optimizer_lr_critic 3e-4 --optimizer_lr_policy 3e-5 \
#         --optimizer_lr_option 3e-5 --clamp_action_logstd False \
#         --use_nn_logstd True --method_loss "v0" --init_temp 1
...
#         --optimizer_lr_critic 3e-4 --optimizer_lr_policy 3e-5 \
#         --optimizer_lr_option 3e-5 --clamp_action_logstd False \
#         --use_nn_logstd True --method_loss "value" --init_temp 1e-3
...
#         --optimizer_lr_critic 3e-4 --optimizer_lr_policy 3e-5 \
#         --optimizer_lr_option 3e-5 --clamp_action_logstd False \
#         --use_nn_logstd True --method_loss "value" --init_temp 1e-2
