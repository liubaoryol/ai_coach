...
python train_dnn/run_algs.py alg=iql base=boxpush_base \
       env=CleanupSingle-v0 tag=sv0seed1 seed=1 supervision=0.0 

python train_dnn/run_algs.py alg=iql base=boxpush_base \
       env=EnvMovers-v0 tag=sv0seed1 seed=1 supervision=0.0 

python train_dnn/run_algs.py alg=iql base=boxpush_base \
       env=EnvCleanup-v0 tag=sv0seed1 seed=1 supervision=0.0 
